...
#Multiple HSV Color Detection
#Contour of HSV Color Detection
#Shape Detector
#Boundaries
...
#lower = {'red':(170, 120, 40), 'green':(66, 120, 40), 'blue':(95, 100, 60), 'yellow':(23, 120, 50), 'orange':(0, 120, 40)} #assign new item lower['blue'] = (93, 10, 0)
#upper = {'red':(180,255,255), 'green':(90,255,255), 'blue':(120,255,255), 'yellow':(54,255,255), 'orange':(20,255,255)}
lower = {'red':(165, 120, 40), 'green':(60, 120, 40), 'blue':(92, 100, 60), 'yellow':(24, 120, 40), 'orange':(10, 120, 150)} #assign new item lower['blue'] = (93, 10, 0)
upper = {'red':(182,255,255), 'green':(80,255,255), 'blue':(112,255,255), 'yellow':(54,255,255),'orange':(20,255,255)}
...
while True:
    ...
    #        if len(cnts) > 0:
                ...
                if radius > 10:
                    ...
                    cv2.putText(frame,key + " color", (int(x+w),int(y+h)), cv2.FONT_HERSHEY_SIMPLEX, 0.6,colors[key],2)
